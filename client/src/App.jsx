...
.mic-button {
  ...
  cursor: pointer;
  font-weight: 900;
  box-shadow: 0 18px 36px rgba(245, 194, 66, 0.38);
}
...
@keyframes pulse {
  0% { box-shadow: 0 0 0 0 rgba(245, 194, 66, 0.5); }
  70% { box-shadow: 0 0 0 22px rgba(245, 194, 66, 0); }
...
.mic-ring {
  position: absolute;
  border-radius: 50%;
  border: 2px solid rgba(245, 194, 66, 0.58);
